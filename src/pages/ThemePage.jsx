...
const ThemePage = () => {
  return (
    <div className="flex w-screen flex-row">
      ...
      <div className="flex flex-col ml-20 border-l-4 border-l-slate-500 space-y-10 w-screen bg-slate-100">
        
        {/* Sunset Theme */}
        <section className="theme-sunset relative w-2/3 h-screen mx-auto mt-20 max-w-4xl overflow-hidden bg-skin-primary sm:rounded-2xl" id="sections1">
          ...
          <div className="relative mx-auto max-w-2xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8">
            ...
            <div className="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
              <p className="flex items-center justify-center rounded-md border border-transparent bg-skin-button-primary px-4 py-3 text-base font-medium text-skin-primary shadow-sm hover:bg-skin-button-secondary">
                Use Sunset Theme
              </p>
            </div>
          </div>
        ...
        {/* Ocean Theme */}
        <section className="theme-ocean relative w-2/3 h-screen mx-auto mt-20 max-w-4xl overflow-hidden bg-skin-primary sm:rounded-2xl" id="sections2">
        ...
        {/* Night Theme */}
        <section className="theme-night relative w-2/3 h-screen mx-auto mt-20 max-w-4xl overflow-hidden bg-skin-primary sm:rounded-2xl" id="sections3">
        ...
        {/* Forest Theme */}
        <section className="theme-forest relative w-2/3 h-screen mx-auto mt-20 max-w-4xl overflow-hidden bg-skin-primary sm:rounded-2xl" id="sections4">
        ...
        {/* Retro Theme */}
        <section className="theme-retro relative w-2/3 h-screen mx-auto mt-20 max-w-4xl overflow-hidden bg-skin-primary sm:rounded-2xl" id="sections5">
